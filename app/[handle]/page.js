...
export default async function Page({ params }) {
    ...
    return <div className="flex min-h-screen bg-purple-400 justify-center items-start py-10 mt-32">
        {item && <div className="photo flex justify-center flex-col items-center gap-4"> 
            ...
            <div className="links">
                {item.links.map((item, index)=>{
                    return <Link  key={index} href= {item.link}><div className="bg-purple-100 py-4 shadow-lg px-2 min-w-96 flex justify-center rounded-md my-3 text-black">
                       {item.linktext}
